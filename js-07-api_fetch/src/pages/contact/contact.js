...
/* 
    La funcion se llama ponerChilito()
    La funcion NO tiene parametro de entreada
...
const ponerChilito = () => {
    const promesaChile = new Promise((resolve) => {
...
irPorElElote( tiempo )
    ...
    .finally( ()=> 
        console.log("Se ha terminado tu promesa")  );
...
const construirTarjetasDeRickandMorty = (personajes) => {
    //sintaxis de map( valor, index, array)
